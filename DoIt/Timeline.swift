    ...
    func loadTimeLineData(){
        ...
        loadData({
            dispatch_async(dispatch_get_main_queue()){
                ...
                let scrollWidth = ((self.defaultTimelinebutton.frame.width+30)*(pointsNumber+3))
                ...
                for var i=self.pointsArray2.count-1; i>=0; i--
                {
                    ...
                    var newPoint:TimelinePoint = TimelinePoint(frame: CGRectMake(90, 40, 45, 45), cDay: self.pointsArray2[i][1] as! Int, cDate: date, chlg: self.pointsArray2[i][3] as! [String])
